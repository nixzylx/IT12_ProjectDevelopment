...
<aside class="sidebar">
    ...
    <nav class="nav-section">
        ...
        <a class="nav-item <?= nav_active('payments.php') ?>" href="payments.php">
    ...
    <nav class="nav-section">
        ...
        <a class="nav-item <?= nav_active('customers.php') ?>" href="customers.php">
            <i class="bi bi-people"></i> Customers
        </a>
        <a class="nav-item <?= nav_active('vehicles.php') ?>" href="vehicles.php">
            <i class="bi bi-truck"></i> Vehicles
        </a>
        <?php if ($isOwner): ?>
            <a class="nav-item <?= nav_active('employees.php') ?>" href="employees.php">
                <i class="bi bi-person-badge"></i> Employees
            </a>
            <a class="nav-item <?= nav_active('admin_approvals.php') ?>" href="admin_approvals.php">
        ...
        <?php endif; ?>
        <a class="nav-item <?= nav_active('warranties.php') ?>" href="warranties.php">
            <i class="bi bi-shield-check"></i> Warranties
        </a>
        <a class="nav-item <?= nav_active('credit_accounts.php') ?>" href="credit_accounts.php">
    ...
    <?php if ($isOwner): ?>
        <nav class="nav-section">
            ...
            <a class="nav-item <?= nav_active('reports.php') ?>" href="reports.php">
